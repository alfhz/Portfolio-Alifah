            ...
            <div class="max-w-6xl mx-auto relative group">
                ...
                <div class="w-full md:w-5/12 p-8 md:p-12 flex flex-col justify-center relative z-10 order-2 md:order-1">
                    ...
                    <div :key="activeTask!.id" class="space-y-4">
                        ...
                        <p class="text-xl font-semibold text-brand-purple">
                        {{ activeTask!.title }}
                        </p>
                ...
                <div class="w-full md:w-7/12 bg-white/40 backdrop-blur-sm p-6 md:p-8 flex items-center justify-center relative order-1 md:order-2 min-h-[300px]">
                    ...
                    <div :key="activeTask!.id" class="w-full h-full flex items-center justify-center relative rounded-2xl overflow-hidden bg-white shadow-inner border border-white/60 aspect-video">
                        ...
                        <iframe 
                            v-if="activeTask!.type === 'document'" 
                            :src="activeTask!.mediaUrl" 
                            class="w-full h-full rounded-2xl custom-iframe"
                    ...
                    <a 
                        ...
                        target="_blank"
                        class="absolute bottom-6 right-6 bg-brand-purple text-white px-8 py-2 rounded-lg font-bold text-xs uppercase tracking-widest shadow-lg hover:bg-[#371e88] transition-all hover:scale-105 z-20 flex items-center justify-center"
                    >
                        See
                    </a>
                </div>
...
const tasks: Task[] = [
    {
        ...
        mediaUrl: '/Penugasan2PersuratanKegiatan.pdf' 
    },
    {
        id: 2,
        label: 'Penugasan 3',
        ...
        type: 'image',
        mediaUrl: '/Penugasan3Infografis.png'
    },
    {
        id: 3,
        label: 'Penugasan 4',
